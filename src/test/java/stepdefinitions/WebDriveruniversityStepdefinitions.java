...
public class WebDriveruniversityStepdefinitions {
    ...
    @Given("user manually goes to {string} homepage")
    public void userManuallyGoesToHomepage(String arg0) {
        Driver.getDriver().get(ConfigReader.getProperty("webdriveruniUrl"));
    }
}